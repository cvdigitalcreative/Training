      ...
      <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
          <a href="javascript:void(0);" data-toggle="collapse" data-target="#galeri-menu">
            <div class="pull-left"><i class="ti-calendar"></i><span class="right-nav-text">Galeri | Tentang</span></div>
            <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
          </a>
          <ul id="galeri-menu" class="collapse" data-parent="#sidebarnav">
             <li> <a href="<?php echo base_url()?>Admin/Album">Kategori Galeri | Tentang</a> </li>
