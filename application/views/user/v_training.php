					...
					<div id="ourBlog" class="p-0 mt-4">
						...
						<div class="col-sm-8 col-md-6 col-lg-4 isotope-item p-3">
							<article class="our-blog-item">
								<a href="<?= base_url()?>Training/<?= $slug?>" target="_blank" class="text-decoration-none">
								...
								<div class="post-infos">
									...
									<h1 class="font-weight-normal">
										<a href="<?= base_url()?>Training/<?= $slug?>" target="_blank" class="text-decoration-none" style="font-size: 20px !important;"><?= $judul?></a>
									</h1>
									<a href="<?= base_url()?>Training/<?= $slug?>" target="_blank" class="text-decoration-none">
