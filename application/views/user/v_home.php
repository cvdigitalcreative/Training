					...
					<div id="revolutionSlider" class="slider rev_slider manual" data-version="5.4.8">
						<ul>
							<li data-transition="fade">
								<img src="<?= base_url()?>assets/img/demos/photography/slides/slide-photography-1.jpg"  
									alt=""
							...
							<li data-transition="fade">
								<img src="<?= base_url()?>assets/img/demos/photography/slides/slide-photography-5.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
							...
							<li data-transition="fade">
								<img src="<?= base_url()?>assets/img/demos/photography/slides/slide-photography-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
							...
							<li data-transition="fade">
								<img src="<?= base_url()?>assets/img/demos/photography/slides/slide-photography-3.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
							...
							<li data-transition="fade">
								<img src="<?= base_url()?>assets/img/demos/photography/slides/slide-photography-4.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
